...
// Generated So. Jan 9 16:14:46 2022
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		this._gang_2_treppe.onclick=function () {
			...
			me._current_selection2.style[domTransition]='none';
			me._current_selection2.ggParameter.rx=320;me._current_selection2.ggParameter.ry=143;
			me._current_selection2.style[domTransform]=parameterToTransform(me._current_selection2.ggParameter);
			me._orientierung2.style[domTransition]='none';
			me._orientierung2.ggParameter.rx=320;me._orientierung2.ggParameter.ry=143;
			me._orientierung2.style[domTransform]=parameterToTransform(me._orientierung2.ggParameter);
		}
		...
		this._map_1_map.ggParameter={ rx:0,ry:0,a:0,sx:0.5,sy:0.5 };
		...
		this._image_31.ggVisible=false;
		...
		this._bibliothek.onclick=function () {
			...
			me._current_selection1.style[domTransition]='none';
			me._current_selection1.ggParameter.rx=335;me._current_selection1.ggParameter.ry=216;
			me._current_selection1.style[domTransform]=parameterToTransform(me._current_selection1.ggParameter);
			me._orientierung1.style[domTransition]='none';
			me._orientierung1.ggParameter.rx=335;me._orientierung1.ggParameter.ry=216;
			me._orientierung1.style[domTransform]=parameterToTransform(me._orientierung1.ggParameter);
		}
		...
		this._gang_1_treppe.onclick=function () {
			...
			me._current_selection1.style[domTransition]='none';
			me._current_selection1.ggParameter.rx=416;me._current_selection1.ggParameter.ry=120;
			me._current_selection1.style[domTransform]=parameterToTransform(me._current_selection1.ggParameter);
			me._orientierung1.style[domTransition]='none';
			me._orientierung1.ggParameter.rx=416;me._orientierung1.ggParameter.ry=120;
			me._orientierung1.style[domTransform]=parameterToTransform(me._orientierung1.ggParameter);
		}
		...
		this._room_1_28.onclick=function () {
			...
			me._current_selection1.style[domTransition]='none';
			me._current_selection1.ggParameter.rx=617;me._current_selection1.ggParameter.ry=200;
			me._current_selection1.style[domTransform]=parameterToTransform(me._current_selection1.ggParameter);
			me._orientierung1.style[domTransition]='none';
			me._orientierung1.ggParameter.rx=617;me._orientierung1.ggParameter.ry=200;
			me._orientierung1.style[domTransform]=parameterToTransform(me._orientierung1.ggParameter);
		}
		...
		this._gang_1_25.onclick=function () {
			me._current_selection1.style[domTransition]='none';
			me._current_selection1.ggParameter.rx=350;me._current_selection1.ggParameter.ry=155;
			me._current_selection1.style[domTransform]=parameterToTransform(me._current_selection1.ggParameter);
			me._orientierung1.style[domTransition]='none';
			me._orientierung1.ggParameter.rx=350;me._orientierung1.ggParameter.ry=155;
			me._orientierung1.style[domTransform]=parameterToTransform(me._orientierung1.ggParameter);
		...
		this._gang_1_15.onclick=function () {
			...
			me._current_selection1.style[domTransition]='none';
			me._current_selection1.ggParameter.rx=218;me._current_selection1.ggParameter.ry=170;
			me._current_selection1.style[domTransform]=parameterToTransform(me._current_selection1.ggParameter);
			me._orientierung1.style[domTransition]='none';
			me._orientierung1.ggParameter.rx=218;me._orientierung1.ggParameter.ry=170;
			me._orientierung1.style[domTransform]=parameterToTransform(me._orientierung1.ggParameter);
		}
		...
		this._map_draussen0=document.createElement('div');
		this._map_draussen0.ggId="Map_Draussen";
		this._map_draussen0.ggParameter={ rx:0,ry:0,a:0,sx:0.09,sy:0.09 };
		this._map_draussen0.ggVisible=true;
		this._map_draussen0.className='ggskin ggskin_image';
		this._map_draussen0.ggType='image';
		hs ='position:absolute;';
		hs+='left: 200px;';
		hs+='top:  9px;';
		hs+='width: 5430px;';
		hs+='height: 4226px;';
		hs+=cssPrefix + 'transform-origin: 0% 0%;';
		hs+=cssPrefix + 'transform: ' + parameterToTransform(this._map_draussen0.ggParameter) + ';';
		hs+='visibility: inherit;';
		this._map_draussen0.setAttribute('style',hs);
		this._map_draussen0__img=document.createElement('img');
		this._map_draussen0__img.className='ggskin ggskin_image';
		this._map_draussen0__img.setAttribute('src',basePath + 'images/map_draussen0.png');
		this._map_draussen0__img.setAttribute('style','position: absolute;top: 0px;left: 0px;-webkit-user-drag:none;');
		this._map_draussen0__img.className='ggskin ggskin_image';
		this._map_draussen0__img['ondragstart']=function() { return false; };
		me.player.checkLoaded.push(this._map_draussen0__img);
		this._map_draussen0.appendChild(this._map_draussen0__img);
		this._map_draussen.appendChild(this._map_draussen0);
		...
		this._button_draussen.onclick=function () {
			...
			if (me.player.transitionsDisabled) {
				...
				me._map_draussen.style[domTransition]='all 500ms ease-out 0ms';
			}
			me._map_draussen.style.opacity='1';
			me._map_draussen.style.visibility=me._map_draussen.ggVisible?'inherit':'hidden';
		...
		me._map_draussen.style[domTransition]='none';
		me._map_draussen.style.opacity='0';
		me._map_draussen.style.visibility='hidden';
		me._button_draussen.onclick();
		me._current_selection3.style[domTransition]='none';
		me._current_selection3.ggParameter.rx=36;me._current_selection3.ggParameter.ry=133;
		me._current_selection3.style[domTransform]=parameterToTransform(me._current_selection3.ggParameter);
		me._orientierung3.style[domTransition]='none';
	...
	function SkinHotspotClass(skinObj,hotspot) {
		...
		if (hotspot.skinid=='Room_Out_2_11') {
			...
			this._image_149.onmouseover=function () {
				...
				me._image_149.ggParameter.sx=0.3;me._image_149.ggParameter.sy=0.3;
